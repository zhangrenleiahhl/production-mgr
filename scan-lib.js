...
window.ScanLib = (function () {
  ...
  /* ---- 没车 / 没质保书不许收尾（2026-09-22 起，2026-09-23 补质保书）-------------
     现场现象：司机根本没扫码签到（车辆还是「未到」），工序却能一路推到
     「装货中 / 已完成」—— 大屏上就出现「已完成 100% + 车辆未到」这种自相矛盾的行。
     车都不在场，装什么货？所以「装货中(2)」「已完成(3)」这两步必须以「车已到」为前提。
     ★ 2026-09-23 追加（用户要求「必须质保书、车到，工序才能点已完成」）：
       最后一档「已完成(3)」还要以「品一质保书已好(bz=1)」为前提 —— 质保书没备好就把工序
       推到已完成，货出门了纸却跟不上。装货中(2) 不看质保书：货可以先装上车、质保书随后补。
     ★ 只拦"往后走"这一步：货好(1)、车辆标记、质保书标记、撤回（applyUndo）全都不受影响 ——
       否则已经推错的老数据就永远退不回来了。
